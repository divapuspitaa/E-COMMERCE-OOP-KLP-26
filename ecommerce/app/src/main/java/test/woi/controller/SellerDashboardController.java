...
public class SellerDashboardController {
    ...
    @FXML private Label lblSellerName, lblDate, lblRoleBadge;
    @FXML private Label lblRevenue, lblOrderCount, lblProductCount;
    ...
    public void initialize() {
        ...
        lblSellerName.setText(me.getDisplayName());
