...
public class AdminDashboardController {
    ...
    @FXML private Label lblAdminName, lblDate;
    ...
    public void initialize() {
        lblAdminName.setText(SessionManager.getInstance().getCurrentUser().getDisplayName());
    ...
    @FXML private void handleDashboard(){ /* already here */ }
